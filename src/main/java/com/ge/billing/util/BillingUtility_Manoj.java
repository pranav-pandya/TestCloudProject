...
public final class BillingUtility_Manoj {
	...
	public static String readFromPropertyFile(String filename,String strKeyName) throws IOException{
		...
		if(null!=filename && null!=strKeyName){
			String strPropertyFileName =/* "C:\\Users\\nj837172\\Documents\\Billing\\bfe-scheduler-1\\src\\main\\resources\\"+*/filename.trim();
	...
	public static List<String> getNewNextInvoiceDateList(String agreementStartDate, Timestamp nextInvoiceDate, String agreementEndDate, 
		...
		if(getDifferenceDays(agreementEndDate,agreementStartDate,"yyyy-MM-dd")>0){
			...
			if(null!=nextInvoiceDate){			
				...
				list=getNewNextInvoiceDate(nextInvoiceDate, month);			
  			...
  			//{   //for Monthly Biling freqency                                                                                                                
	  			...
	  			try{
	  				...
	  				if( newNextInvDatelng >= currDatelng ){	
		  				...
		  				if(rcStDatelng >= prCyDatelng){     //  pcdate:12/1/2016  ---   rcdate:12/5/2016   1stofMonth, monthly
		  				...
		  				else   //  pcdate:10/5/2016  ---   rcdate:10/1/2016   5thofMonth, monthly
		  				{
			  				...
			  				System.out.println("prCyDatelng"+prCyDatelng+"::::currDatelng:"+currDatelng);
		...
		for(InvoiceDTO invoiceDTOObj : invoiceDTOList){
			...
			if(String.valueOf(invoiceDTOObj.getFullCycleFlag()).equalsIgnoreCase("Y")){
				if(invoiceDTOObj.getBillingFrequence().equalsIgnoreCase("Monthly")){
					invoiceDTOObj.setAmount(round(invoiceDTOObj.getMrcAmount(),2));
				}
				else{
					invoiceDTOObj.setAmount(round(invoiceDTOObj.getRcAmount(),2));
				}
			}
			else{
				//invoiceDTOObj.setAmount(0.0);//here prorated logic has TODO
				InvoiceDTO invoiceDTO=getInvoiceAmountProrated(invoiceDTOObj);
				invoiceDTOObj.setAmount(round(invoiceDTO.getAmount(),2));
			}
		}
...
//	for(InvoiceDTO invoiceDTO :invoiceDTOList ){
	public static InvoiceDTO getInvoiceAmountProrated(InvoiceDTO invoiceDTO){
			...
			if(invoiceDTO.getBillingFrequence().equalsIgnoreCase("Monthly")){	
				...
				invoiceDTO.setAmount(round(invoiceAmount, 2));
				System.out.println("amount:::::"+invoiceDTO.getAmount());
			}
			else {	
					System.out.println("****Else LOOP  Quarterly SemiAnnaul and Annual****");
		...
		int invEdDate=getDayFromTimestampDateFormat(invEndDate);
		 ...
		 invAmount = (mrcAmount/DaysInAMonth)*daysDiff;		 
		  ...
		  // ex:11/10/2016 - 12/04/2016;  As it comes under differt months, Invoice should be calculated as (11/10/2016 - 11/30/2016 & 12/1/2016 - 12/04/2016)
			 ...
			 System.out.println("getInvAmountPro Else loop tempInvAmount Total Amount::"+tempInvAmount);
...
/*	public static void main(String[] args) throws Exception {	
		...
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2017-02-02 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setInvoiceCycleStart("5thofQuarter");
		contractDTO.setBillingFrequency("Quarterly");
		
        contractDTO.setRcStartDt(convertStringDateToTimestamp("2016-11-01 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2016-11-30 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setInvoiceCycleStart("1stofMonth");
		contractDTO.setBillingFrequency("Monthly");
		
		contractDTO.setRcStartDt(convertStringDateToTimestamp("2016-05-01 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2016-11-02 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		...
		contractDTO.setRcStartDt(convertStringDateToTimestamp("2016-11-01 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2017-01-20 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setInvoiceCycleStart("5thofQuarter");
		contractDTO.setBillingFrequency("Quarterly");
		
		contractDTO.setRcStartDt(convertStringDateToTimestamp("2016-11-25 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2017-01-20 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setInvoiceCycleStart("5thofQuarter");
		contractDTO.setBillingFrequency("Quarterly");
		
        billing_frequency = 'Quarterly';
        invoice_cycle_start = '1st of Quarter';
        nxt_invoice_dt = '2016-07-01 07:00:00';
        rc_start_dt = '2016-07-01 07:00:00';
        line_start_dt = '2016-07-01 07:00:00';
        charge_end_dt = '2016-09-20 07:00:00';
       line_end_dt = '2016-09-20 07:00:00'; 1
		
        billing_frequency = 'Quarterly';
        invoice_cycle_start = '15th of Quarter';
        nxt_invoice_dt = '2016-11-15 07:00:00';
        rc_start_dt = '2016-11-15 07:00:00';
        line_start_dt = '2016-11-15 07:00:00';
        charge_end_dt = '2017-02-10 07:00:00';
       line_end_dt = '2017-02-10 07:00:00'; 1

        billing_frequency = 'Quarterly';
        invoice_cycle_start = '1st of Quarter';
        nxt_invoice_dt = '2016-11-01 07:00:00';
        rc_start_dt = '2016-11-01 07:00:00';
        line_start_dt = '2016-11-01 07:00:00';
        charge_end_dt = '2017-01-20 07:00:00';
       line_end_dt = '2017-01-20 07:00:00';


		contractDTO.setRcStartDt(convertStringDateToTimestamp("2016-11-01 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setChargeEndDt(convertStringDateToTimestamp("2017-01-20 00:00:00.000","yyyy-MM-dd hh:mm:ss.sss"));
		contractDTO.setInvoiceCycleStart("1stofQuarter");
		contractDTO.setBillingFrequency("Quarterly");
